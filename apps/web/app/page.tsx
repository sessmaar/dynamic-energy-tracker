...
/**
 * Convergence Engine Console.
 *
 * Server component: runs the engine end-to-end on every request against
 * deterministic seeded data. No client JS for the data view itself —
 * the dashboard is a static, fast render of pure-function output. The
 * mobile app does the same calculations on-device against AsyncStorage
 * data; this page proves the engine renders identically in a different
 * runtime.
 */
export default function ConsolePage() {
  ...
  // TDEE posterior line: one point per week, plus the "true" TDEE for reference.
  ...
  // Weight: raw daily scatter + EWMA trend line.
  ...
  // Last 7 days of intake for the runway + sparkline up top.
  ...
  const activeYieldNow = Math.max(0, todayIntake - currentTarget); // proxy demo number
    ...
    <>
      ...
      <header className="topnav">
        <div className="container topnav-inner">
          <span className="topnav-logo">
            DET<span style={{ color: "var(--accent)" }}>·</span>CONSOLE
          </span>
          <nav>
            <Link href="/" className="active">Demo</Link>
            <Link href="/dashboard">Live</Link>
            <Link href="/log-meal">Log Meal</Link>
            <Link href="/import">Import</Link>
            <Link href="#tdee">TDEE</Link>
            <Link href="#weight">Mass</Link>
      ...
      <main className="container section">
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "var(--gap-lg)" }}>
          <div>
            <span className="eyebrow">System · Convergence Engine</span>
            <h1 className="h1" style={{ marginTop: 16 }}>CONSOLE</h1>
            <p style={{ color: "var(--muted)", maxWidth: 540, marginTop: 16 }}>
              ...
              Engine state runs server-side against deterministic seed data.
            </p>
          </div>
        ...
        <div className="tg tg-4" style={{ marginBottom: "var(--gap-lg)" }}>
          ...
          <div className="tg-cell">
            ...
            <span className="num" style={{ fontSize: 22, fontWeight: 700, color: "var(--accent)" }}>
        ...
        <section id="tdee" className="card card-lg" style={{ marginBottom: "var(--gap-lg)" }}>
          <div className="row between" style={{ marginBottom: "var(--gap-md)" }}>
            <div>
        ...
        <section id="audit">
          ...
          <div className="tg tg-4" style={{ gridTemplateColumns: "1.2fr 1fr 1fr 1fr 1fr 0.8fr" }}>
            <div className="tg-cell"><span className="meta">Week</span></div>
            <div className="tg-cell"><span className="meta">Avg Intake</span></div>
            <div className="tg-cell"><span className="meta">Δ Trend Mass</span></div>
            <div className="tg-cell"><span className="meta">Inferred TDEE</span></div>
            <div className="tg-cell"><span className="meta">Posterior</span></div>
            <div className="tg-cell"><span className="meta">α</span></div>
      ...
      <footer style={{ borderTop: "var(--hairline)", marginTop: "var(--gap-xl)" }}>
        <div className="container" style={{ padding: "32px 16px", display: "flex", justifyContent: "space-between" }}>
          <span className="meta">© 2026 Dynamic Energy Tracker · Convergence Engine</span>
          <span className="meta">Server-rendered · No client JS in data view</span>
        </div>
      </footer>
    </>
  );
